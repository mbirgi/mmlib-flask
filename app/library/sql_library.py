...
class SQLLibrary():
    ...
    def _make_db_playlist(self, sp_playlist):
        ...
        self._add_item_tracks(db_playlist, sp_playlist['tracks'])
        return db_playlist
    ...
    def _update_lib_playlist(self, lib_playlist, sp_playlist):
        ...
        lib_playlist.tracks = []
        self._add_item_tracks(lib_playlist, sp_playlist['tracks'])
        return lib_playlist
    ...
    def update_saved_playlists(self, sp_playlists):
        for sp_playlist in sp_playlists:
            ...
            if lib_playlist is None:
                lib_playlist = self._make_db_playlist(sp_playlist)
            else:
                self._update_lib_playlist(lib_playlist, sp_playlist)
