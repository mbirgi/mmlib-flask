...
def _refresh_saved_albums():
    ...
    update_saved_albums(saved_albums)
    album_tracks = lib.get_album_tracks(saved_albums)
...
def _refresh_saved_playlists():
    ...
    update_saved_playlists(saved_playlists)
